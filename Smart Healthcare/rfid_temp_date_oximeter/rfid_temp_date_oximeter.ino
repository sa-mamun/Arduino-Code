...
void setup()
{
    ...
    //rtc.setTime(04, 52, 00);     // Set the time to 12:00:00 (24hr format)
    //rtc.setDate(12, 01, 2019);   // Set the date to January 1st, 2014
...
void loop()
{
    ...
    //-------------Date------------//
      ...
      strID += String(maxTemp) + nDate + puls + oxi;
      maxTemp = 0.0;

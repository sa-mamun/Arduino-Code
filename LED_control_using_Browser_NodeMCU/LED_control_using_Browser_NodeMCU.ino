...
const char* ssid = "BAD BOYZ"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "Mk011143006"; // Your Wifi password, in case you have open network comment the whole statement.
